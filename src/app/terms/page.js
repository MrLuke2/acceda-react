...
const FontLoader = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .statement-content li::before { content: '→'; color: var(--electric); flex-shrink: 0; }
  ...
  return (
    <>
      ...
      <div aria-hidden="true" style={{
        ...
        background: "radial-gradient(ellipse, rgba(58,123,255,0.06) 0%, transparent 70%)",
      ...
      <main id="main-content" tabIndex="-1" style={{ paddingTop: 160 }}>
        <div className="container">
          ...
          >
            <div className="eyebrow">Platform Governance</div>
          ...
          <div className="statement-content">
            ...
            >
              <h2>Master Subscription Agreement</h2>
              <p>
                These Terms of Service govern your access to and use of the Acceda platform. By accessing or using our services, you agree to be bound by these terms. If you are entering into these terms on behalf of an organization, you represent that you have the authority to bind that organization.
              </p>
            </motion.section>
            ...
            >
              <h2>Usage Rights & Restrictions</h2>
              <p>
                Acceda grants you a non-exclusive, non-transferable right to access and use the platform for your organization's internal compliance and accessibility remediation purposes.
              </p>
              <ul>
                <li>You may not use the platform to build a competing accessibility service.</li>
                <li>You may not attempt to reverse engineer or circumvent the platform's security controls.</li>
                <li>All automated scans must be performed within the usage limits of your subscription tier.</li>
              </ul>
            </motion.section>
            ...
            >
              <h2>Professional Services & Data Accuracy</h2>
              <p>
                While Acceda employs advanced AI and expert-validated remediation guides, automated scanning by nature cannot detect 100% of accessibility violations. Our service is a tool to assist your teams in achieving and maintaining compliance.
              </p>
              <p>
                Final compliance sign-off remains the responsibility of your organization's legal and accessibility officers. Acceda helps compile the evidence required for those decisions.
              </p>
            </motion.section>
            ...
            >
              <h2>Legal Queries</h2>
              <p>
                For any legal questions regarding our terms or custom enterprise agreements, please contact our legal department:
              </p>
              <ul>
                <li>Email: legal@useacceda.com</li>
